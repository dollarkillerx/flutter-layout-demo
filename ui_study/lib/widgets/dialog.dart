                        ...
                        ? Container(
                            ...
                            child: TextButton(
                              ...
                              style: TextButton.styleFrom(
                                backgroundColor: widget.cancelColor == null
                                    ? Color(0xFFFFFFFF)
                                    : widget.cancelColor,
                                foregroundColor: widget.cancelColor == null
                                    ? Color(0xFFFFFFFF)
                                    : widget.cancelColor,
                              ),
                            ),
                ...
                Expanded(
                    child: Container(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: widget.confirmColor == null
                              ? Color(0xFFFFFFFF)
                              : widget.confirmColor,
                          foregroundColor: widget.confirmColor == null
                              ? Color(0xFFFFFFFF)
                              : widget.confirmColor,
                        ),
                      ),
